  ...
  return (
    <div className={style.UImessage}>
      <div className={style.chatmessage} id='addMessage'>
        <div className={style.clientmessage}> You : hello </div>
        <div className={style.servermessage}> Server : wonderfull</div>
        <div className={style.clientmessage}> You : hello </div>
        <div className={style.servermessage}> Server : wonderfull</div>
        <div className={style.clientmessage}> You : hello </div>
        <div className={style.servermessage}> Server : wonderfullwonderfullwonderfullwonderfullwonder fullwonderfullwonderfullwonderfull</div>
        <div className={style.clientmessage}> You : hello </div>
        <div className={style.servermessage}> Server : wonderfull</div>
        <div className={style.clientmessage}> You : hello </div>
        <div className={style.servermessage}> Server : wonderfull</div>
